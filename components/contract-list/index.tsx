...
занятия. Родитель оплачивает 8 (восемь) занятий вперед.`}</p>
      ...
      <p className={styles.redP}>{`
      5.1. Договор считается заключенным с момента его подписания и действует до 31.08.27г. Стороны имеют право в одностороннем порядке расторгнуть настоящий договор, уведомив вторую сторону за 1 (один) календарный день.
      `}</p>
      <div className={styles.flex}>
        <p>
