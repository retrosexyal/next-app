  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.redP}>
        ...
        791192337 от 04 марта 2024 г., с одной стороны, и ${info.FIOP} ( в
...
соответствовать возрасту, на который рассчитана программа занятий группы.`}
      ...
      >{`2.1. Стоимость разового занятия - 10 рублей, абонемент на месяц, включающий 8 занятий - 70 рубля.`}</p>
      <p
        className={styles.redP}
      >{`Стоимость разового полуторачасового занятия – 15 рублей, абонемент на месяц, включающий 4 занятия – 52 рублей.`}</p>
      <p
        className={styles.redP}
...
занятия. Родитель оплачивает 8 (восемь) занятий вперед.`}</p>
      ...
      <p className={styles.redP}>{`
      5.1. Договор считается заключенным с момента его подписания и действует до 31.08.25г. Стороны имеют право в одностороннем порядке расторгнуть настоящий договор, уведомив вторую сторону за 1 (один) календарный день.
      `}</p>
      <div className={styles.flex}>
        <p>
          ...
          <div>212039, г. Могилев, ул. Краснозвёздная, 68, кв. 147</div>
      ...
      <div className={styles.btn_container} style={{ paddingTop: "10px" }}>
        <label>
          ...
          />
          Я прочитал(а) условия договора и согласен(на) его подписать, а также
