...
соответствовать возрасту, на который рассчитана программа занятий группы.`}
      ...
      >{`2.1. Стоимость разового занятия - 9 рублей, абонемент на месяц, включающий 8 занятий - 64 рубля.`}</p>
      <p
        className={styles.redP}
      >{`Стоимость разового полуторачасового занятия – 14 рублей, абонемент на месяц, включающий 4 занятия – 49 рублей.`}</p>
      <p
        className={styles.redP}
